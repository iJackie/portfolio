...
export const EVENTS: EventItem[] = [
  ev({
    ...
    photos: ['/assets/events/2024-singapore-liquidstaking/flyer_LiquidStakingNight.webp'],
  ...
  ev({
    ...
    photos: [
      '/assets/events/2024-singapore-beracup/flyer_Beracup.webp',
      '/assets/events/2024-singapore-beracup/BannerBeracup.webp',
    ],
  ...
  ev({
    ...
    photos: ['/assets/events/2024-bangkok-beracup/flyer_BeracupDevcon.webp'],
  ...
  ev({
    ...
    photos: ['/assets/events/2024-bangkok-hotpotdao/flyer_HotpotDao.webp'],
  ...
  ev({
    ...
    photos: [
      '/assets/events/2024-bangkok-beraspa/flyer_BeraSpa.webp',
      '/assets/events/2024-bangkok-beraspa/photo_BeraSpa2.webp',
      '/assets/events/2024-bangkok-beraspa/BeraSpa.webp',
    ],
  ...
  ev({
    ...
    photos: ['/assets/events/2024-bangkok-honeyhour/flyer_HoneyHour.webp'],
  ...
  ev({
    ...
    photos: [
      '/assets/events/2025-denver-honeyhappyhour/flyer_HoneyHappyHour.webp',
      '/assets/events/2025-denver-honeyhappyhour/HHHPanel.webp',
    ],
  ...
  ev({
    ...
    photos: [
      '/assets/events/2024-taipei-infrared101/flyer_Infrared101.webp',
      '/assets/events/2024-taipei-infrared101/banners.webp',
      '/assets/events/2024-taipei-infrared101/bear-standee-banner.webp',
      '/assets/events/2024-taipei-infrared101/standup2.webp',
      '/assets/events/2024-taipei-infrared101/merch-table.webp',
      '/assets/events/2024-taipei-infrared101/stickers.webp',
      '/assets/events/2024-taipei-infrared101/balloons.webp',
    ],
  ...
  ev({
    ...
    photos: ['/assets/events/2025-denver-infraredbowl/flyer_InfraredBowl.webp'],
  ...
  ev({
    ...
    photos: [
      '/assets/events/2025-denver-allin/flyer_InfraredAllIn.webp',
      '/assets/events/2025-denver-allin/loungspace.webp',
    ],
    featured: true,
  }),
  ...
  ev({
    ...
    photos: [
      '/assets/events/2024-taipei-mrblock-2024/flyer_MrBlock2024.webp',
      '/assets/events/2024-taipei-mrblock-2024/SpeakerCard.webp',
      '/assets/events/2024-taipei-mrblock-2024/SpeakerAudience.webp',
    ],
  ...
  ev({
    ...
    photos: [
      '/assets/events/2022-nyc-petroni-pizza-party/flyer.webp',
      '/assets/events/2022-nyc-petroni-pizza-party/pizza.webp',
      '/assets/events/2022-nyc-petroni-pizza-party/chef-portrait.webp',
      '/assets/events/2022-nyc-petroni-pizza-party/petroni-hand.webp',
      '/assets/events/2022-nyc-petroni-pizza-party/art-direction.webp',
      '/assets/events/2022-nyc-petroni-pizza-party/how-it-works.webp',
    ],
    videos: [
      '/assets/events/2022-nyc-petroni-pizza-party/party-clip.mp4',
    ],
    links: [
  ...
  ev({
    ...
    photos: [
      '/assets/events/2025-taipei-mrblock-2025/flyer_MrBlock2025.avif',
      '/assets/events/2025-taipei-mrblock-2025/MRBlockSpeakerCard.webp',
      '/assets/events/2025-taipei-mrblock-2025/SummitView.webp',
      '/assets/events/2025-taipei-mrblock-2025/SummitCrowd2025.webp',
      '/assets/events/2025-taipei-mrblock-2025/Base.webp',
      '/assets/events/2025-taipei-mrblock-2025/Base2.webp',
      '/assets/events/2025-taipei-mrblock-2025/base3.webp',
    ],
  ...
  ev({
    ...
    photos: ['/assets/events/2025-hongkong-honeyhour/flyer_HKHoneyHour.webp'],
  ...
  ev({
    ...
    photos: [
      '/assets/events/2025-seoul-beras/flyer_BerasInSeoul.avif',
      '/assets/events/2025-seoul-beras/KimistriConf.webp',
      '/assets/events/2025-seoul-beras/KimistriMerch.webp',
      '/assets/events/2025-seoul-beras/KimistriSelfie.webp',
    ],
  ...
  ev({
    ...
    photos: ['/assets/events/2025-dubai-honeyhour/flyer_HoneyHourMagna.avif'],
  ...
  ev({
    ...
    photos: [
      '/assets/events/2025-seoul-kbw/flyer_KBWShuttle.avif',
      '/assets/events/2025-seoul-kbw/ShuttleBanner.webp',
      '/assets/events/2025-seoul-kbw/ShuttlePic.webp',
      '/assets/events/2025-seoul-kbw/Shuttle1.webp',
      '/assets/events/2025-seoul-kbw/ShuttleCafe.webp',
      '/assets/events/2025-seoul-kbw/SeoulMerch.webp',
      '/assets/events/2025-seoul-kbw/CafeCupSleeve.webp',
    ],
  ...
  ev({
    ...
    photos: [
      '/assets/events/2025-sicily-infrared-offsite/OffsiteItinerary.webp',
      '/assets/events/2025-sicily-infrared-offsite/Map.webp',
      '/assets/events/2025-sicily-infrared-offsite/View1.webp',
      '/assets/events/2025-sicily-infrared-offsite/View2.webp',
      '/assets/events/2025-sicily-infrared-offsite/View3.webp',
      '/assets/events/2025-sicily-infrared-offsite/InfraredShirt.webp',
      '/assets/events/2025-sicily-infrared-offsite/OffsiteTowelMerch.webp',
      '/assets/events/2025-sicily-infrared-offsite/TeamMerch.webp',
      '/assets/events/2025-sicily-infrared-offsite/GroupPic.webp',
    ],
  }),
  ...
  ev({
    ...
    photos: [
      '/assets/events/2025-nyc-edible-nft-food-hunt/nyc-map.webp',
      '/assets/events/2025-nyc-edible-nft-food-hunt/eat-to-earn-header.webp',
      '/assets/events/2025-nyc-edible-nft-food-hunt/exclusive-dish-drops.webp',
      '/assets/events/2025-nyc-edible-nft-food-hunt/howtoplay.webp',
      '/assets/events/2025-nyc-edible-nft-food-hunt/eat-it.webp',
      '/assets/events/2025-nyc-edible-nft-food-hunt/claim-it.webp',
      '/assets/events/2025-nyc-edible-nft-food-hunt/earn-it.webp',
      '/assets/events/2025-nyc-edible-nft-food-hunt/win-it.webp',
      '/assets/events/2025-nyc-edible-nft-food-hunt/partners.webp',
      '/assets/events/2025-nyc-edible-nft-food-hunt/join-8it-fam.webp',
      '/assets/events/2025-nyc-edible-nft-food-hunt/wtfaq.webp',
      '/assets/events/2025-nyc-edible-nft-food-hunt/last-project.webp',
      '/assets/events/2025-nyc-edible-nft-food-hunt/lead-gen-title.webp',
    ],
    links: [
  ...
  ev({
    ...
    photos: [
      '/assets/events/2025-dubai-infravestor-dinner/flyer.webp',
      '/assets/events/2025-dubai-infravestor-dinner/Keyvisual.webp',
      '/assets/events/2025-dubai-infravestor-dinner/LockVisual.webp',
      '/assets/events/2025-dubai-infravestor-dinner/dinner-tablescape.webp',
      '/assets/events/2025-dubai-infravestor-dinner/Menu.webp',
    ],
  ...
  ev({
    id: '2025-tokyo-akasaka-aura',
    name: 'Akasaka Aura: Berachain Evening',
    ...
    color: '#E94B35',
    description:
      'An evening bringing the Berachain community together in Tokyo\'s Akasaka district. Doors open at 17:30, program runs 18:00–20:30 — talks, mixing, and Japan-market context for the Infrared and Berachain ecosystems.',
    stats: [
      { value: 'TYO', label: 'edition' },
      { value: '2.5h', label: 'program' },
      { value: '🌸',  label: 'evening' },
      { value: '🇯🇵',  label: 'japan' },
    ],
    photos: [
      '/assets/events/2025-tokyo-akasaka-aura/flyer_AkasakaAura.webp',
      '/assets/events/2025-tokyo-akasaka-aura/AkasakaBanner.webp',
      '/assets/events/2025-tokyo-akasaka-aura/AkasakaSpeaker.webp',
      '/assets/events/2025-tokyo-akasaka-aura/AkasakaMerch.webp',
      '/assets/events/2025-tokyo-akasaka-aura/AkasakaTable.webp',
    ],
    links: [{ label: 'event page', url: 'https://lu.ma/o5p4r7m9' }],
    featured: true,
  }),
];
